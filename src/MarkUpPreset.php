...
class MarkUpPreset extends Preset
{
    /** @var Command */
    protected $command;
    ...
    protected static function updateSass()
    {
        ...
        copy(__DIR__.'/../markup-stubs/bootstrap/app.scss', resource_path('sass/app.scss'));
    }
    ...
    {
        copy(__DIR__.'/../markup-stubs/bootstrap/webpack.mix.js', base_path('webpack.mix.js'));
    }
    ...
    {
        copy(__DIR__.'/../markup-stubs/bootstrap/bootstrap.js', resource_path('js/bootstrap.js'));
        copy(__DIR__.'/../markup-stubs/bootstrap/app.js', resource_path('js/app.js'));
    }
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../markup-stubs/auth', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../markup-stubs/layouts', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../markup-stubs/home.blade.php', resource_path('views/home.blade.php'));
